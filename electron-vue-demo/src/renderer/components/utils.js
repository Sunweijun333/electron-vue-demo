function Play(id, from) {
    ...
    if (document.getElementById('toolPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cnhttps://so.gushiwen.cn/viewplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
      var xmlhttp;
      ...
      xmlhttp.open("GET", "https://so.gushiwen.cnhttps://so.gushiwen.cnhttps://so.gushiwen.cn/viewplay.aspx?id=0", false);
      xmlhttp.send();
    }
}
...
function delBeisong(idbei) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cnhttps://so.gushiwen.cnhttps://so.gushiwen.cn/user/collectbeldel.aspx?delId=" + idbei, false);
    xmlhttp.send();
}
...
function OnYiwen(id) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cnhttps://so.gushiwen.cn/nocdn/ajaxshiwencont.aspx?id=" + id+"&value="+value, false);
    xmlhttp.send();
}
...
function changeLike(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/shiwen2017/likeding.aspx?shoucang=false&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
        else {
            var xmlhttp;
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/shiwen2017/likeding.aspx?shoucang=true&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
    }
}
...
function changeLikeMingju(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/mingju/likeding.aspx?shoucang=false&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
        else {
            var xmlhttp;
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/mingju/likeding.aspx?shoucang=true&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
    }
}
...
function changeLikeAuthor(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/authors/likeding.aspx?shoucang=false&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
        else {
            var xmlhttp;
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/authors/likeding.aspx?shoucang=true&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
    }
}
...
function changeLikeGuwen(id,idkey, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        if (likeImg == -1) {
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/likeding.aspx?shoucang=false&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
        else {
            var xmlhttp;
            ...
            var myDate = new Date();
            xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/likeding.aspx?shoucang=true&id=" + idkey + "&time=" + myDate.toLocaleTimeString(), true);
            xmlhttp.send();
        }
    }
}
...
function ShowYizhu(id, from) {
    if (document.getElementById('leftbtn' + id).innerHTML == "译文") {
        ...
        if (document.getElementById('rightbtn' + id)) {
            ...
            xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/ajaxbfanyi.aspx?id=" + id, false);
            xmlhttp.send();
        }
    }
    else {
...
function ShowYizhuYuanchuang(id, state) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/ajaxbfanyiYuanchuang.aspx?id=" + id + "&state=" + state, false);
    xmlhttp.send();
...
function ziliaoShow(id) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cn/authors/ajaxziliao.aspx?id=" + id, false);
    xmlhttp.send();
}
...
function fanyiShow(id, idjm) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cn/nocdn/ajaxfanyi.aspx?id=" + idjm, false);
    xmlhttp.send();
}
...
function shangxiShow(id, idjm) {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cn/nocdn/ajaxshangxi.aspx?id=" + idjm, false);
    xmlhttp.send();
}
...
function ding(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/fyding2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function pai(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/fypai2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function dingsx(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/sxding2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function paisx(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/sxpai2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function dingzl(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/zlding2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function paizl(id, from) {
    if (getCookie('gsw2017user') == null) {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/zlpai2017.aspx?id=" + id + "&from=" + from, true);
        xmlhttp.send();
    }
}
...
function Play(id, from) {
    if (document.getElementById('toolPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/viewplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        var xmlhttp;
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/viewplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayShangxi(id, from) {
    if (document.getElementById('shangxiPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/shangxiplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/shangxiplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayFanyi(id, from) {
    if (document.getElementById('fanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/fanyiplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/fanyiplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayZiliao(id, from) {
    if (document.getElementById('ziliaoPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/ziliaoplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/ziliaoplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayAuthor(id, from) {
    if (document.getElementById('authorPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/authorplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/authorplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayBook(id, from) {
    if (document.getElementById('bookPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bookplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bookplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayBookv(id, from) {
    if (document.getElementById('bookvPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bookvplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bookvplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function PlayBvfanyi(id, from) {
    if (document.getElementById('bvfanyiPlay' + id).style.display == "none") {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bvfanyiplay.aspx?id=" + id, false);
        xmlhttp.send();
    }
    else {
        ...
        xmlhttp.open("GET", "https://so.gushiwen.cn/guwen/bvfanyiplay.aspx?id=0", false);
        xmlhttp.send();
    }
}
...
function showBos() {
    ...
    xmlhttp.open("GET", "https://so.gushiwen.cn/shiwen2017/ajaxSearchSo.aspx?valuekey=" + encodeURI(valuekey), true);
    xmlhttp.send();
}
